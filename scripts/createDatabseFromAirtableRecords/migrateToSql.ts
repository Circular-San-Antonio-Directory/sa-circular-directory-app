...
import { Client } from 'pg'; // Assuming you're using pg client
...
type LookupMapping = Record<string, number>;

/** Mappings object passed to insertBusinesses */
interface BusinessMappings {
 ...
 */
async function executeSchemaFile(client: DbClient): Promise<void> {
 ...
 */
function mapIdsToArray(airtableIds: string[] | undefined, mapping: LookupMapping): number[] | null {
